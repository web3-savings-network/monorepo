...
export interface ERC20TWABInterface extends utils.Interface {
  contractName: "ERC20TWAB";
  functions: {
...
export type NewUserTwabEvent = TypedEvent<
  ...
  { delegate: string; newTwab: ObservationLib.ObservationStructOutput }
>;
...
export interface ERC20TWAB extends BaseContract {
  contractName: "ERC20TWAB";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC20TWABInterface;
