...
export interface PoolyPixelStorageInterface extends utils.Interface {
  contractName: "PoolyPixelStorage";
  functions: {
...
export interface PoolyPixelStorage extends BaseContract {
  contractName: "PoolyPixelStorage";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PoolyPixelStorageInterface;
