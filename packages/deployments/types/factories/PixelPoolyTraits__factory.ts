...
import type {
  PixelPoolyTraits,
  PixelPoolyTraitsInterface,
} from "../PixelPoolyTraits";
...
type PixelPoolyTraitsConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: PixelPoolyTraitsConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class PixelPoolyTraits__factory extends ContractFactory {
  constructor(...args: PixelPoolyTraitsConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
      super(_abi, _bytecode, args[0]);
    }
    this.contractName = "PixelPoolyTraits";
  }

  deploy(
    overrides?: Overrides & { from?: string | Promise<string> }
  ): Promise<PixelPoolyTraits> {
    return super.deploy(overrides || {}) as Promise<PixelPoolyTraits>;
  }
  ...
  attach(address: string): PixelPoolyTraits {
    return super.attach(address) as PixelPoolyTraits;
  }
  connect(signer: Signer): PixelPoolyTraits__factory {
    return super.connect(signer) as PixelPoolyTraits__factory;
  }
  static readonly contractName: "PixelPoolyTraits";
  public readonly contractName: "PixelPoolyTraits";
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PixelPoolyTraitsInterface {
    return new utils.Interface(_abi) as PixelPoolyTraitsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PixelPoolyTraits {
    return new Contract(address, _abi, signerOrProvider) as PixelPoolyTraits;
  }
}
