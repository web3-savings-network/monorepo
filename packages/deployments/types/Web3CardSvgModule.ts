...
export interface Web3CardSvgModuleInterface extends utils.Interface {
  contractName: "Web3CardSvgModule";
  functions: {
...
export interface Web3CardSvgModule extends BaseContract {
  contractName: "Web3CardSvgModule";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Web3CardSvgModuleInterface;
