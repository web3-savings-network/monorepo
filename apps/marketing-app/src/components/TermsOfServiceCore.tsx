  ...
  return (
    <div className={containerClassName}>
      ...
      <p>
        ...
        Interface is distinct from the Protocol. T Web3 Savings Cards (Kames Cox
        Geraghty) does not control or operate any version of the Protocol on any
        blockchain network. By using the Interface, you understand that you are
        not buying or selling digital assets from us and that we do not operate
        any PoolTogether prize pools.
      </p>
      <p>
      ...
      <ul className="list-disc pl-8">
        ...
        <li className="my-2 leading-6">
          {" "}
          <em>Fraud and Misrepresentation</em>. Activity that seeks to defraud
        ...
        <li className="my-2 leading-6">
          {" "}
          <em>Any Other Unlawful Conduct</em>. Activity that violates any
          applicable law, rule, or regulation of the United States or another
          relevant jurisdiction, including (but not limited to) the restrictions
          and regulatory requirements imposed by U.S. law.
        </li>
      </ul>
      <p>
      ...
      <p>
        In summary, you acknowledge that we (Kames Cox Geraghty) are not
        responsible for any of these variables or risks, do not own or control
        the PoolTogether protocol, and cannot be held liable for any resulting
        losses that you experience while accessing or using the Interface.
        Accordingly, you understand and agree to assume full responsibility for
        all of the risks of accessing and using the Interface to interact with
      ...
      <p className="">
        Web3 Savings Cards uses the PoolTogether protocol, which has entities in
        the state of New York, which is why we expect visitors to the Web3
        Savings Cards website(s) to follow the laws pursuant to the state of New
        York's jurisdiction.
      </p>
      <p>
