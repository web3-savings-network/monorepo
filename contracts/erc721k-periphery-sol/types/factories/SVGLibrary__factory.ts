...
export class SVGLibrary__factory extends ContractFactory {
  ...
  static linkBytecode(
    ...
    linkedBytecode = linkedBytecode.replace(
      new RegExp("__\\$f6856915f7b50105d8cc6bcdbf698ccc1f\\$__", "g"),
      linkLibraryAddresses["contracts/svg/svg.sol:svg"]
        .replace(/^0x/, "")
        .toLowerCase()
    );

    linkedBytecode = linkedBytecode.replace(
      new RegExp("__\\$e60f8c3ac5f1be6dd681f7ee0e7b73b376\\$__", "g"),
      linkLibraryAddresses["contracts/svg/svgUtils.sol:svgUtils"]
        .replace(/^0x/, "")
        .toLowerCase()
    );
...
export interface SVGLibraryLibraryAddresses {
  ["contracts/svg/svg.sol:svg"]: string;
  ["contracts/svg/svgUtils.sol:svgUtils"]: string;
}
