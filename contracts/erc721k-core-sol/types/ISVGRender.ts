...
export interface ISvgRenderInterface extends utils.Interface {
  contractName: "ISvgRender";
  functions: {
...
export interface ISvgRender extends BaseContract {
  contractName: "ISvgRender";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISvgRenderInterface;
