...
export interface ENounsInterface extends utils.Interface {
  contractName: "ENouns";
  functions: {
    ...
    "getEnsReverseRecords()": FunctionFragment;
    ...
    "previewUsingEnsName(string)": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "safeTransferFrom(address,address,uint256)": FunctionFragment;
    "setApprovalForAll(address,bool)": FunctionFragment;
    "setEnsReverseRecords(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getEnsReverseRecords",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "previewUsingEnsName",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setEnsReverseRecords",
    values: [string]
  ): string;
  ...
  events: {
    ...
    "EnsReverseRecordsUpdated(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "EnsReverseRecordsUpdated"): EventFragment;
...
export type EnsReverseRecordsUpdatedEvent = TypedEvent<
  [string],
  { ensReverseRecords: string }
>;

export type EnsReverseRecordsUpdatedEventFilter =
  TypedEventFilter<EnsReverseRecordsUpdatedEvent>;
...
export interface ENouns extends BaseContract {
  contractName: "ENouns";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ENounsInterface;
  ...
  functions: {
    ...
    getEnsReverseRecords(overrides?: CallOverrides): Promise<[string]>;

    getId(user: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    preview(user: string, overrides?: CallOverrides): Promise<[string]>;
    ...
    setEnsReverseRecords(
      _ensReverseRecords: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  previewUsingEnsName(name: string, overrides?: CallOverrides): Promise<string>;
  ...
  filters: {
    ...
    "EnsReverseRecordsUpdated(address)"(
      ensReverseRecords?: null
    ): EnsReverseRecordsUpdatedEventFilter;
    EnsReverseRecordsUpdated(
      ensReverseRecords?: null
    ): EnsReverseRecordsUpdatedEventFilter;
  ...
  estimateGas: {
    ...
    getEnsReverseRecords(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    preview(user: string, overrides?: CallOverrides): Promise<BigNumber>;
