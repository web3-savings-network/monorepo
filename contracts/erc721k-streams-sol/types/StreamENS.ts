...
export interface StreamENSInterface extends utils.Interface {
  contractName: "StreamENS";
  functions: {
...
export interface StreamENS extends BaseContract {
  contractName: "StreamENS";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StreamENSInterface;
