...
export interface ENounsStorageInterface extends utils.Interface {
  contractName: "ENounsStorage";
  functions: {
...
export interface ENounsStorage extends BaseContract {
  contractName: "ENounsStorage";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ENounsStorageInterface;
